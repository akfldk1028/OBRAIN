...
brain_archive_root=${BRAIN_ARCHIVE_ROOT:-/srv/brain/backups}
brain_vault_root=${BRAIN_VAULT_ROOT:-/srv/brain}
brain_data_root=${BRAIN_DATA_ROOT:-/srv/brain/data}
brain_config_file=${BRAIN_CONFIG_FILE:-/etc/brain-mcp-config.json}
