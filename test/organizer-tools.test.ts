...
function fakeOrganizer(): OrganizerServiceApi & { calls: string[] } {
  ...
  return {
    ...
    async propose(input) { calls.push(`propose:${input.path}`); return { id: "PRP-abcdefgh", vault: input.vault, sourcePath: input.path, sourceHash: "a".repeat(64), destinationPath: "10_Areas/note.md", policyVersion: "1", createdAt: "2026-01-01T00:00:00.000Z", expiresAt: "2026-01-02T00:00:00.000Z", status: "pending", semanticStatus: "active", targetDirectory: "10_Areas", title: "note", type: "study", tags: [], summary: "summary", relatedNotePaths: [], confidence: 0.9, reason: "reason" }; },
