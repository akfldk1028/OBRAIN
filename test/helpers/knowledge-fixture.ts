...
export async function createKnowledgeFixture(ids: string[], organizer?: OrganizerServiceApi) {
  ...
  const knowledge = new KnowledgeBase(registry, index, coordinator, audit, organizer);
  return {
    knowledge,
    rootOf(id: string) {
